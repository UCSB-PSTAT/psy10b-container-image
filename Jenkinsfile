                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"agricolae\");library(\"beanplot\");library(\"car\");library(\"DescTools\");library(\"effsize\");library(\"ez\");library(\"foreign\");library(\"ggstatsplot\");library(\"PairedData\");library(\"pastecs\");library(\"pgirmess\");library(\"pwr\");library(\"reshape\");library(\"reshape2\");library(\"rockchalkca\");library(\"tidyr\");library(\"vcd\");library(\"WRS2\")"'
